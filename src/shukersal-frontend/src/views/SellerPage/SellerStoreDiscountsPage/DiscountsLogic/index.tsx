...
const TreeNode = ({ node }) => {
  ...
  switch (discountOn) {
    ...
    case 1:
      discountdisplay = (
        <span>
          {discount}% discount on {discountOnString} category:
        </span>
      );
      break;
    case 2:
      discountdisplay = (
        <span>
          {discount}% discount on {discountOnString} product:
        </span>
      );
      break;
    default:
        ...
        <table>
          ...
          <tr>
            <td>
              <ul>
                {discountRuleBoolean ? (
                  <TreeNodeB node={discountRuleBoolean} />
                ) : null}
              </ul>
            </td>
          </tr>
...
const TreeNodeB = ({ node }) => {
  ...
  switch (discountRuleBooleanType) {
    ...
    case 3:
      ...
      display = (
        <span>
          minimal {conditionString} product count : {conditionLimit}
        </span>
      );
      break;
    case 4:
      ...
      display = (
        <span>
          maximal {conditionString} product count : {conditionLimit}
        </span>
      );
      break;
    case 5:
      ...
      display = (
        <span>
          minimal {conditionString} category count : {conditionLimit}
        </span>
      );
      break;
    case 6:
      ...
      display = (
        <span>
          maximal {conditionString} category count : {conditionLimit}
        </span>
      );
      break;
    case 7:
      display = (
        <span>
          applies from {minHour}:00 to {maxHour}:00
        </span>
      );
      break;
    default:
  ...
  return (
    <>
      ...
      {value4 == 0
        ...
        : value4 == 1
        ? sdiscount.map((discount) => (
            <div key={discount.id}>
              {discount ? <TreeNode node={discount} /> : null}
            </div>
          ))
        : value4 == 2
        ? purchaserules.map((pr) => (
            <div key={pr.id}>
              <TreeNodeC node={pr} />
            </div>
          ))
        : value4 == 3
        ? spurchaserule.map((pr) => (
            <div key={pr.id}>{pr ? <TreeNodeC node={pr} /> : error}</div>
          ))
        : null}
      <Listbox
        dataKey="id"
      ...
      {value == 0 ? (
        <button
          onClick={() => {
            discountsApi.createNewDiscount(
              storeId,
              value1,
              discount,
              discountOn
        ...
        <button
          onClick={() => {
            discountsApi.selectDiscount(storeId, selected_id);
            window.location.reload();
          }}
        >
          Select
        ...
        <button
          onClick={() => {
            discountsApi.selectPRule(storeId, selected_id);
            window.location.reload();
          }}
        >
          Select
        ...
        <button
          onClick={() => {
            discountsApi.createChildDiscount(
              storeId,
              value1,
              discount,
              discountOn,
        ...
        <button
          onClick={() => {
            discountsApi.createConditionalDiscount(
              storeId,
              value2,
              discountLimit,
              discountOnCheck,
        ...
        <button
          onClick={() => {
            discountsApi.createConditionalChildDiscount(
              storeId,
              value2,
              discountLimit,
              discountOnCheck,

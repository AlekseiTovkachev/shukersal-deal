...
namespace shukersal_backend.Tests
{
    public class MultiThreadTests
    {
        ...
        [Fact]
        public async Task AddProduct_Multithreaded_TwoThreads()
        {
            // Arrange
            var store = new Store
            {
            ...
            Thread thread1 = new Thread(() =>
            {
                ...
                {
                    var result1 = _controller.AddProduct(store.Id, post, dummyMember);
                    isThread1Completed = result1.IsCompleted; 
                }
            });
            ...
            Thread thread2 = new Thread(() =>
            {
                ...
                {
                    var result2 = _controller.AddProduct(store.Id, post, dummyMember);
                    isThread1Completed = result2.IsCompleted;
                }
            });
        ...
        [Fact]
        public async Task UpdateProduct_Multithreaded_TwoThreads()
        {
            // Arrange
            var existingProduct = new Product
            {
            ...
            Thread thread1 = new Thread(() =>
            {
                ...
                {
                    var result1 = _controller.UpdateProduct(existingProduct.StoreId, existingProduct.Id, patch1, dummyMember);
                    nameThread1 = result1.Result.Result.Name;
                }
            });
            ...
            Thread thread2 = new Thread(() =>
            {
                ...
                {
                    var result2 = _controller.UpdateProduct(existingProduct.StoreId, existingProduct.Id, patch2, dummyMember);
                    nameThread2 = result2.Result.Result.Name;
                }
            });
            ...
            // Assert
            Assert.True(nameThread1 == patch1.Name || nameThread2 == patch2.Name);
        }

        //TODO: couldn't add checking inventory because GET/product/{id} not implemented properly 

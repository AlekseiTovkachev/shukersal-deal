...
namespace shukersal_backend.Tests.AcceptanceTests
{
    public class T2_2_3_AddItem : AcceptanceTest
    {
        ...
        public void AddItemPositive()
        {
            ...
            var res = bridge.AddItemToCart(1, new Models.ShoppingItem { Id = 100, Product = product, Quantity = 1});
            res.Wait();
        ...
        public void AddItemQuantity()
        {
            ...
            var res = bridge.AddItemToCart(1, new Models.ShoppingItem { Id = 100, Product = product, Quantity = 2 });
            res.Wait();
        ...
        {
            var product = bridge.GetStoreProducts(1).Result.Value.Products.ElementAt(0);
            var res1 = bridge.AddItemToCart(1, new Models.ShoppingItem { Id = 100, Product = product, Quantity = 1 });
            var res2 = bridge.AddItemToCart(1, new Models.ShoppingItem { Id = 200, Product = product, Quantity = 1 });
            res1.Wait();
            res2.Wait();
        ...
        {
            var res = bridge.AddItemToCart(1, new Models.ShoppingItem { Id = 100, Product = new Product { Id = -1 }, Quantity = 1 });
            res.Wait();
            Assert.False(res.Result is IActionResult);
        }
    }
